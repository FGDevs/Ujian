...
function deletecart(id){
    ...
    var cartqty=cart[indexcart].qty
    console.log(cartqty)
    arrProduct.splice(indexplihan,1,{
        ...arrProduct[indexplihan],
        stock:parseInt(arrProduct[indexplihan].stock)+cartqty,
    })
...
let funBuy=(id)=>{
    ...
    if(arrProduct[indexplihan].stock>0){
        var productstock=arrProduct[indexplihan].stock
        productstock--
